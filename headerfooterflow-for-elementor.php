...
/**
 * Plugin Name:       Header Footer Doctor for Elementor
 ...
 *
 * Header Footer Doctor for Elementor is free software: you can redistribute it
 ...
 * @var string
 */
define( 'HFDOCTOR_DIR', plugin_dir_path( __FILE__ ) );
 ...
 * @var string
 */
define( 'HFDOCTOR_URL', plugin_dir_url( __FILE__ ) );
 ...
 * @var string
 */
define( 'HFDOCTOR_MIN_ELEMENTOR_VERSION', '3.5.0' );
 ...
 * @var string
 */
define( 'HFDOCTOR_SUPPORTED_THEME', 'hello-elementor' );

require_once HFDOCTOR_DIR . 'includes/class-plugin.php';
 ...
 * @since 1.0.0
 *
 * @return \HFDoctor\Plugin The shared plugin instance.
 * @api
 */
function hfdoctor(): \HFDoctor\Plugin {
	return \HFDoctor\Plugin::instance();
}
